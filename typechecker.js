...
// when i type in my sentence tag (keyUp), update the output tag accordingly (function)
// if there's no value, put in the original text

sentenceTag.addEventListener('keyup', function() {
  //   we use special word this for any repeatable code in between the bracket
  if (this.value) {
...
typefaceTag.addEventListener('input', function() {
  ...
  typefaceOutput.innerHTML = this.value
})
